...
The null finding for the solo elderly rate is broadly consistent with prior Japanese ecological evidence that regional antidiabetic prescribing variation is strongly associated with supply-side healthcare structure rather than a single social vulnerability indicator [@inoue_2021_sglt2_regional]. Together, these findings suggest that in Japan's universal health insurance system, regional prescribing heterogeneity may be more strongly shaped by provider-side and system-level factors than by prefectural-level social disadvantage alone [@okui_2022; @okuda_2023].
